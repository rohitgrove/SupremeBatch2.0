...
public class MinimumAsciiDeleteSumForTwoStrings {
    public static int solveUsingRecursion(String s1, String s2, int i, int j) {
        int cost = 0;
        ...
        if (s1.charAt(i) == s2.charAt(j)) {
            ...
            int cost1 = s1.charAt(i) + solveUsingRecursion(s1, s2, i + 1, j);
            int cost2 = s2.charAt(j) + solveUsingRecursion(s1, s2, i, j + 1);
