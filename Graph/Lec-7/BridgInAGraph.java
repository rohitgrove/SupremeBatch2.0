...
public class BridgInAGraph {
    public static void criticalConnectionsHelper(int src, int parent, HashMap<Integer, List<Integer>> adjList,
            int timer, List<List<Integer>> ans, int[] tin, int[] low, HashMap<Integer, Boolean> visited) {
    ...
    public static List<List<Integer>> criticalConnections(int n, List<List<Integer>> connections) {
        ...
        criticalConnectionsHelper(src, parent, adjList, timer, ans, tin, low, visited);
