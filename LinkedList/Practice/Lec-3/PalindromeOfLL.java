public class PalindromeOfLL {
    ...
    public static void main(String[] args) {
        ...
        LinkedList oddLL2 = new LinkedList();
        oddLL2.insertAtPosition(1, 1);
        oddLL2.insertAtPosition(2, 2);
        oddLL2.insertAtPosition(3, 3);
        oddLL2.insertAtPosition(4, 4);
        oddLL2.insertAtPosition(1, 5);
        System.out.println(isPalindrome(oddLL2.head));

        LinkedList evenLL = new LinkedList();
        evenLL.insertAtPosition(1, 1);
        evenLL.insertAtPosition(2, 2);
        evenLL.insertAtPosition(3, 3);
        evenLL.insertAtPosition(3, 4);
        evenLL.insertAtPosition(2, 5);
        evenLL.insertAtPosition(1, 6);
        System.out.println(isPalindrome(evenLL.head));

        LinkedList evenLL2 = new LinkedList();
        evenLL2.insertAtPosition(1, 1);
        evenLL2.insertAtPosition(2, 2);
        evenLL2.insertAtPosition(3, 3);
        evenLL2.insertAtPosition(4, 4);
        evenLL2.insertAtPosition(2, 5);
        evenLL2.insertAtPosition(1, 6);
        System.out.println(isPalindrome(evenLL2.head));
    }
}
