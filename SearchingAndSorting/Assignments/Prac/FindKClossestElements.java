...
public class FindKClossestElements {
    public static List<Integer> bruteForce(int[] arr, int x, int k) {
    ...
    public static List<Integer> twoPtrMethod(int arr[], int k, int x) {
        int l = 0;
        int h = arr.length - 1;
        while (h - l >= k) {
            if (x - arr[l] > arr[h] - x) {
