...
public class MinimumTimeDiffrence {
    public static int findMinDifference(List<String> timePoints2) {
        List<Integer> mins = new ArrayList<>();
        for (String str : timePoints2) {
            mins.add(convertInInteger(str));
        }
    ...
    public static int convertInInteger(String time) {
